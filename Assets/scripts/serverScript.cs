...
public class serverScript : MonoBehaviour
{
	...
	// symbols
	public static List<string> sReelSymbols = new List<string>{"A","B","C","D","E","J"};
    
	// symbol's weights
	private static List<int> sReelOneWeights = new List<int>{10,10,10,10,10,10};
	private static List<int> sReelTwoWeights = new List<int>{10,20,30,40,50,5};
	private static List<int> sReelThreeWeights = new List<int>{10,20,30,40,50,5}; 
...
//				Debug.Log ("Amount: " + outcome.GetAward ());
//			}
//		}
	}
	...
	public spinResult Spin (int betAmt)
	{
		int weight = 0;
		string symbol = "";
		...
		// reset last spin results
		this.mLastSpinResults = null;       
		this.mLastWinAmount = 0;
		...
		// determine awards
		this.mLastWinAmount = payoutScript.GetAwardAmt (ref this.mLastSpinResults, betAmt);
